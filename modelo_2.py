...
pkl_filename = "D:/Almacenamiento/Descargas/diagnostico_2/diagnostico_2v3-master_v3/Modelo_Random_Forest.pkl"
with open(pkl_filename, 'rb') as file:
    model_rf = pickle.load(file)

# Cargar el archivo local que contiene el dataset
ruta_archivo = 'D:/Almacenamiento/Descargas/diagnostico_2/diagnostico_2v3-master_v3/DATA/Data_Final_egresos_y_camillas.csv'
